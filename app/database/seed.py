...
def seed_demo_data():
    ...
    categories_by_name = {
        ...
        for category in Category.query.filter(
            Category.name.in_(EVENT_CATEGORIES)
        ).all()
    }
    ...
    event_definitions = [
        {
            ...
            "venue_name": "Weser Innovation Hall", "address": "14 Demo Quay",
            "city": "Bremen", "country": "Germany",
            "start_offset": timedelta(days=14), "end_offset": timedelta(days=14, hours=3),
            "capacity": 50, "privacy": "Public", "status": "Published",
            "categories": ["Technology", "Networking"],
        },
        {
            "title": "Hamburg Community Workshop",
            "description": "A hands-on planning session for fictional neighbourhood projects.",
            "venue_name": "Harbour Community Studio", "address": "8 Sample Lane",
            "city": "Hamburg", "country": "Germany",
            "start_offset": timedelta(days=7), "end_offset": timedelta(days=7, hours=2),
            "capacity": 5, "privacy": "Public", "status": "Published",
        ...
        },
        {
            ...
            "venue_name": "Demo Sound Room", "address": "22 Example Strasse",
            "city": "Berlin", "country": "Germany",
            "start_offset": timedelta(days=21), "end_offset": timedelta(days=21, hours=4),
            "capacity": 3, "privacy": "Public", "status": "Published",
        ...
        },
        {
            ...
            "venue_name": "Thames Demo Centre", "address": "5 Example Square",
            "city": "London", "country": "United Kingdom",
            "start_offset": timedelta(days=35), "end_offset": timedelta(days=35, hours=3),
            "capacity": None, "privacy": "Public", "status": "Published",
        ...
        },
        {
            ...
            "venue_name": "Vistula Design Lab", "address": "19 Sample Street",
            "city": "Warsaw", "country": "Poland",
            "start_offset": timedelta(days=10), "end_offset": timedelta(days=10, hours=3),
            "capacity": 25, "privacy": "Public", "status": "Published",
        ...
        },
        {
            ...
            "venue_name": "Private Meeting Room", "address": "3 Internal Way",
            "city": "Leipzig", "country": "Germany",
            "start_offset": timedelta(days=5), "end_offset": timedelta(days=5, hours=2),
            "capacity": 8, "privacy": "Private", "status": "Published",
            "categories": ["Networking"],
        },
        {
            "title": "Dresden Future Food Fair",
            "description": "A draft concept for a fictional sustainable food fair.",
            "venue_name": "Elbe Exhibition Space", "address": "41 Preview Road",
            "city": "Dresden", "country": "Germany",
            "start_offset": timedelta(days=28), "end_offset": timedelta(days=28, hours=5),
            "capacity": 100, "privacy": "Public", "status": "Draft",
            "categories": ["Food & Drink"],
        },
        {
            "title": "Cologne Riverside Run",
            "description": "A cancelled fictional community running event.",
            "venue_name": "Riverside Meeting Point", "address": "7 Cancelled Route",
            "city": "Cologne", "country": "Germany",
            "start_offset": timedelta(days=3), "end_offset": timedelta(days=3, hours=2),
            "capacity": 40, "privacy": "Public", "status": "Cancelled",
            "categories": ["Sports & Fitness"],
        },
        {
            "title": "Bremen Makers Day Archive",
            "description": "A completed fictional makers event retained for dashboard history.",
            "venue_name": "Weser Workshop", "address": "10 Archive Quay",
            "city": "Bremen", "country": "Germany",
            "start_offset": timedelta(days=-10), "end_offset": timedelta(days=-10, hours=3),
            "capacity": 30, "privacy": "Public", "status": "Published",
            "categories": ["Technology", "Education & STEM"],
        },
        {
            "title": "Hamburg Networking Breakfast Archive",
            "description": "A completed fictional professional breakfast event.",
            "venue_name": "Harbour Breakfast Room", "address": "16 Archive Street",
            "city": "Hamburg", "country": "Germany",
            "start_offset": timedelta(days=-30), "end_offset": timedelta(days=-30, hours=2),
            "capacity": None, "privacy": "Public", "status": "Published",
            "categories": ["Networking"],
        },
    ]
    ...
    for event_data in event_definitions:
        event, created = _demo_event(
            organiser, now, event_data, categories_by_name
        )
    ...
    attendance_plan = {
        ...
        "Hamburg Community Workshop": [
            "demo_attendee", "demo_jordan", "demo_samira", "demo_tomasz",
        ],
        "Berlin Indie Music Night": [
            "demo_attendee", "demo_jordan", "demo_samira",
        ],
